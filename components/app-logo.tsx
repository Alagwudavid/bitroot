...
export function AppLogo({ className }: AppLogoProps) {
  return (
    <Link href="/" className={`flex items-center font-mono text-gray-600 dark:text-[#fafafa] ${className || ""}`}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 2.86 3.11"
        className="size-6 md:size-8 text-[#9E1156]"
        style={{
      ...
      <span className="flex md:hidden ml-2 text-lg font-semibold">BitRoot</span>
    </Link>
  );
}