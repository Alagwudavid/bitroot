    ...
    {isMobile && (
      <header className="shrink-0 w-full h-14 mt-2 pl-4 md:pl-8 pr-8 grid grid-cols-[1fr_auto_1fr] gap-1 md:grid-cols-[minmax(100px,_1fr)_minmax(300px,_auto)_minmax(100px,_1fr)] md:gap-4 theme-aware">
        ...
        <div className="flex items-center justify-end gap-4">
          <Link
            href={"/notifications"}
            className="relative h-10 w-10 rounded-full p-0 text-gray-600 dark:text-[#fafafa] backdrop-blur-md bg-white/30 shrink-0 text-lg flex items-center justify-center border theme-aware"
          >
          ...
          <div className="flex items-center space-x-6">
            ...
            >
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className="relative h-10 w-10 rounded-full p-1 text-gray-600 dark:text-[#fafafa] backdrop-blur-md bg-white/30 overflow-hidden theme-aware"
                >
                  <img
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="relative h-10 w-10 rounded p-1 text-gray-600 dark:text-[#fafafa] backdrop-blur-md bg-white/30 border theme-aware"
              >
