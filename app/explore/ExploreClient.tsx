                    ...
                    <div className="flex overflow-x-auto gap-2 pb-2 scrollbar-hide">
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`rounded-md px-3 py-2 text-sm font-medium whitespace-nowrap transition-all duration-200 border ${activeTab === cat
                            ...
                            (activeTab === "All" || activeTab === section) && (
                                <section key={section}>
                                    ...
                                    {loading ? (
                                        ...
                                        <div
                                            className={`grid grid-cols-${sectionCounts[
                                                section as keyof typeof sectionCounts
                                                ]?.[0] || 1
                                                } md:grid-cols-${sectionCounts[
                                                section as keyof typeof sectionCounts
                                                ]?.[1] || 3
                                                } lg:grid-cols-${sectionCounts[
                                                section as keyof typeof sectionCounts
                                                ]?.[2] || 6
                                                } gap-4`}
                                        >
                                            ...
                                            {[
                                                ...
                                                getFilteredSection(section).map(
                                                    (item: any, idx: number) => (
                                                        <Card
                                                            key={idx}
                                                            className={`shadow-none border transition-colors cursor-pointer-custom group ${sectionCardStyles[section] ||
