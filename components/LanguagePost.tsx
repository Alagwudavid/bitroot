        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            <Button
              ...
              size="sm"
              onClick={handleLike}
              className={`p-2 h-auto hover:bg-red-50 group transition-all duration-200 ${
                isLiked ? 'text-red-500' : 'text-muted-foreground'
              }`}
            >
              <Heart 
                className={`h-5 w-5 ${isLiked ? 'fill-current' : ''} group-hover:text-red-500 transition-colors duration-200 ${
                  isLiked ? 'animate-scale-in' : ''
                }`} 
              />
