              ...
              <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
                {levels.map((level, index) => (
                  <div key={level.level} className="flex flex-col items-center">
                    ...
                    <span className="mt-4 text-white dark:text-[#fafafa] font-medium text-sm">
                      {level.title}
                    </span>
                  </div>
                ))}
            ...
            <Card className="bg-white dark:bg-[#0d1117] rounded-2xl">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3 mb-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 dark:text-[#fafafa] mb-1">
                      Try Super for free
                    </h4>
                    <p className="text-sm text-gray-600 dark:text-[#fafafa]/70">
                      No ads, personalized practice test, and unlimited
                      legendary!
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-4 mb-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-semibold text-gray-800 dark:text-[#fafafa]">
                      {streak}
                    </span>
                    <span className="text-sm text-gray-600 dark:text-[#fafafa]/70">
                      day streak
                    </span>
                  </div>
                </div>
