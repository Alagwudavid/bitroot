...
const features = [
    {
        ...
        title: "Translator",
        description:
            "Instantly translate words, phrases, or sentences between languages.",
    },
    {
        icon: MessageCircle,
        title: "Chat",
        description:
            "Converse with the AI in your target language or practice conversations.",
    },
    {
        icon: BookOpen,
        title: "Flashcards",
...
export default function BeetClient() {
    return (
