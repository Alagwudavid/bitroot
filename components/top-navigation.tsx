    ...
    <>
      <header className="h-14 bg-transparent flex items-center justify-between px-6 md:px-12 theme-aware shrink-0 border-0">
        ...
        <div className="flex items-center space-x-4">
          <Link
            href={"/ai-agent"}
            className="h-10 rounded-md bg-transparent shrink-0 text-lg flex items-center justify-center text-gray-600 dark:text-[#fafafa]/70"
          >
            <svg
              className="size-8"
              viewBox="0 0 24 24"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="relative h-10 w-10 rounded p-0"
              >
                <svg
                  className="!size-9 shrink-0 text-gray-600 dark:text-[#fafafa]/70"
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
